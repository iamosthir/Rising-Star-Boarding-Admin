                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:800px;">
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <h2
                                            ...
                                            Your Grooming Appointment Was Approved.
                                        </h2>
                                    </td>
                                </tr>
                                <tr>
                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td width="55%" align="left"
                                                    ...
                                                    {{ $data["bookingData"]["created_at"]->format("d F Y") }}
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td width="25%" align="left"
                                                    ...
                                                    {{ $data["bookingData"]["customer"]["first_name"]." ".$data["bookingData"]["customer"]["last_name"] }}
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="2" align="left"
                                                    ...
                                                    <table style="width: 100%;">
                                                        ...
                                                        @foreach ($data["bookingData"]["pets"] as $i=>$pet)
                                                        <tr style="font-weight: lighter;">
                                                            <td align="center">{{ $i+1 }}</td>
                                                            <td>{{ $pet["name"]. " - ". $pet["color"] }}</td>
                                                        </tr>    
                                                        @endforeach
                                                    </table>
                                                </td>
                    ...
                    <tr>
                        <td align="center" height="100%" valign="top" width="100%"
                            style="padding: 0 15px 55px 15px; background-color: #ffffff;" bgcolor="#ffffff">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                style="max-width:600px;">
                                <tr>
                    ...
                    <tr>
                        <td align="center" style=" padding: 35px; background-color: #41c9ff;" bgcolor="#b91bAb">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <p
                                            style="color: #666666; font-size: 14px; font-weight: 600; line-height: 18px; margin-bottom: 0;">
