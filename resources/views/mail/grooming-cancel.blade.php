                                        ...
                                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td width="55%" align="left"
                                                    ...
                                                    {{ \Carbon\Carbon::parse($data["bookingData"]["created_at"])->format("d F Y") }}
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td width="75%" align="left"
                                                    style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding: 5px 10px;">
                                                    Selected Date & Time for appointment
                                                </td>
                                                <td width="25%" align="left"
                                                    style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 600; line-height: 24px; padding: 5px 10px;">
                                                    {{ \Carbon\Carbon::parse($data["bookingData"]["appointment_date"])->format("d F Y - h:i a") }}
                                                </td>
                                            </tr>
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <p style="color: #666666; font-size: 14px; font-weight: 600; line-height: 25px; margin-bottom: 0;">
