                    ...
                    <div class="card-body" v-if="!is_loading">
                        <div class="row justify-content-center">
                            <div class="col-md-12 text-center">
                                ...
                                <img v-else class="user-img" src="/images/user-placeholder.png">
                            </div>
                            <!-- Show section -->
                            <div class="col-md-8 text-center mt-5" v-if="!profileEditMode && !passwordEditMode">
                                <h4><strong>{{ profileData.name }}</strong> <span v-if="profileData.role == 'super'" class="font-13">(Super Admin)</span></h4>
    ...
    methods:{
        getProfileInfo(){
            ...
            .then(resp=>{
                ...
                this.profileForm.allowEmail = data.allow_emails;
