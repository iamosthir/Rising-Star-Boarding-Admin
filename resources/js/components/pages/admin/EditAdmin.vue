                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <label class="custom-switch p-0">
                                                <input
                                                type="checkbox" name="custom-switch-checkbox" class="custom-switch-input" v-model="profileForm.role">
                                                <span class="custom-switch-indicator"></span>
                                                <span class="custom-switch-description">Give Super Permissions</span>
                                            </label>
                                        </div>
        ...
        getProfileInfo(){
            ...
            .then(resp=>{
                ...
                if(data.status == "ok"){
                    ...
                    this.profileForm.role = data.data.role=='super'?true:false;
