                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <template v-if="admins.length == 0">
                                        <p class="text-center text-muted"><strong>No admin created</strong></p>
                                    </template>

                                    <template v-else>
                                        <tr v-for="(admin,i) in admins" :key="i">
                                            <td>
                                                <img :src="`/uploads/admin/${admin.photo}`" class="user-round" alt="" v-if="admin.photo">
                                                <img src="/images/user-placeholder.png" class="user-round" alt="" v-else>
                                            </td>
                                            <td>{{ admin.name }}</td>
                                            <td>{{ admin.email }}</td>
                                            <td>{{ admin.role=='super'?'Super Admin':'General' }}</td>
                                            <td>
